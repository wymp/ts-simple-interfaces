...
export class SimpleHttpServerExpress implements SimpleHttpRequestHandlerInterface {
  ...
  public use(
    ...
    this.app.use(middleware as express.RequestHandler | Array<express.RequestHandler>);
    return this;
  }
  ...
  public catch(
    ...
    this.app.use(errorHandler as express.ErrorRequestHandler | Array<express.ErrorRequestHandler>);
    return this;
  }
  ...
  public all(
    ...
    this.app.all(route, handlers as express.RequestHandler | Array<express.RequestHandler>);
    return this;
  }
  ...
  public get(
    ...
    this.app.get(route, handlers as express.RequestHandler | Array<express.RequestHandler>);
    return this;
  }
  ...
  public post(
    ...
    this.app.post(route, handlers as express.RequestHandler | Array<express.RequestHandler>);
    return this;
  }
  ...
  public patch(
    ...
    this.app.patch(route, handlers as express.RequestHandler | Array<express.RequestHandler>);
    return this;
  }
  ...
  public put(
    ...
    this.app.put(route, handlers as express.RequestHandler | Array<express.RequestHandler>);
    return this;
  }
  ...
  public delete(
    ...
    this.app.delete(route, handlers as express.RequestHandler | Array<express.RequestHandler>);
    return this;
  }
  ...
  public head(
    ...
    this.app.head(route, handlers as express.RequestHandler | Array<express.RequestHandler>);
    return this;
  }
  ...
  public options(
    ...
    this.app.options(route, handlers as express.RequestHandler | Array<express.RequestHandler>);
    return this;
  }

  public listen(userCallback?: (listener: [Port, Host | undefined], args: Array<unknown>) => unknown): Array<Server> {
    if (this.config.listeners.length === 0) {
      throw new Error(`You've called 'listen', but you haven't passed any listeners in your config.`);
    } else {
